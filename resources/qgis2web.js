...
map.getView().fit([-851157.827742, 7112369.808202, -650345.078693, 7237857.995748], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Attractions Louth and Monaghan</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (47 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = ' Business Case for<br /> Glamping Pods <br />In Inniskeen';
            }
